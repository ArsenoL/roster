...
export function InventoryTab({ clubId }: { clubId: string }) {
 ...
 <Card><CardContent className="p-4"><div className="w-8 h-8 rounded-lg bg-foreground dark:bg-blue-950/30 flex items-center justify-center mb-2"><Boxes className="h-4 w-4 text-foreground" /></div><div className="text-xs text-muted-foreground">Total Items</div><div className="text-xl font-bold">{summary.totalItems}</div></CardContent></Card>
 <Card><CardContent className="p-4"><div className="w-8 h-8 rounded-lg bg-foreground dark:bg-emerald-950/30 flex items-center justify-center mb-2"><Package className="h-4 w-4 text-foreground" /></div><div className="text-xs text-muted-foreground">Available</div><div className="text-xl font-bold">{summary.available}</div></CardContent></Card>
 <Card><CardContent className="p-4"><div className="w-8 h-8 rounded-lg bg-foreground dark:bg-amber-950/30 flex items-center justify-center mb-2"><ArrowRightLeft className="h-4 w-4 text-foreground" /></div><div className="text-xs text-muted-foreground">Out on Loan</div><div className="text-xl font-bold">{summary.outOnLoan}</div></CardContent></Card>
 <Card><CardContent className="p-4"><div className="w-8 h-8 rounded-lg bg-foreground dark:bg-purple-950/30 flex items-center justify-center mb-2"><DollarSign className="h-4 w-4 text-foreground" /></div><div className="text-xs text-muted-foreground">Total Value</div><div className="text-xl font-bold">{formatCurrency(summary.totalValue)}</div></CardContent></Card>
 </div>
