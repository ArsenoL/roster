...
-- NOTE: auth.uid() is provided by Supabase automatically — we don't
-- redefine it here. It returns the UUID of the authenticated user from
-- the JWT, or NULL if not authenticated.

-- Create a schema for our helper functions (keeps them organized)
